# den-mcp Development Guide

## Project Overview

den-mcp is a centralized MCP server + CLI for task management, agent messaging, and document storage across multiple projects. It replaces task-master-ai with a custom solution.
